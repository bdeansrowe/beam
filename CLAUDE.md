...
**Probabilistic mask:** fire N probe rays per edge pixel, record hit probability, threshold for skip/dispatch. More accurate but significantly more complex. Revisit only if SKY_MASK_DILATION_RADIUS=2 proves insufficient for silhouette quality at game viewing distances.
